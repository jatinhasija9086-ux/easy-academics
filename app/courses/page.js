...
export default function CoursesPage() {
  ...
  />
          ...
          >
            <div>
              ...
              >
                Choose Your
                <br />
                <span className="text-[#062DA0]">Academic Path.</span>
              </motion.h2>
            </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          >
            ...
            >
              Request a
              <br />
              <span className="text-[#062DA0]">Free Counselling.</span>
            </motion.h2>
      ...
      {/* =========================================================
          FOOTER
      ========================================================= */}
      <footer id="contact" className="bg-black px-5 py-14 text-white sm:px-8 lg:px-10">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            <div>
              <div className="text-2xl font-black tracking-tight">
                EASY <span className="text-[#FFD43A]">ACADEMICS</span>
              </div>
